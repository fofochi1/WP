  ...
  <body>
    ...
    <form action="">
      <select name="names" onchange="showWins(this.value)">
        ...
        <option value="<?php echo htmlspecialchars($loggedInUser);?>">Wins</option>
        <option value="<?php echo htmlspecialchars($loggedInUser);?>">Losses</option>
      </select>
    </form>
    <br>
    <div id="txtHint">
      Wins will be posted here
    </div>
